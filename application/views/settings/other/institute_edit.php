...
<div class="form-group row">
        ...
        <div class="col-10">
            <input class="form-control" type="text" value="<?=$result["name"]?>" name="institute" id="institute" required>
        </div>
    </div>
    ...
    <div class="form-group row"> 
        <div class="col-12">
            ...
            <input type="submit" class="btn btn-primary pull-right" value="Edit Institute">
        </div>
    </div> 
