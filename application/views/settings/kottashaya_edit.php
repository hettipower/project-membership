...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Edit Divisional Secretariat</li>
</ol>
...
<div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-10">
            <input type="text" name="divi_secretariat" id="divi_secretariat" class="form-control" value="<?=$result["name"]?>" required>
        </div>
    </div>
